<?php
     ...
     $intento = 0;
         ...
         if(isset($enviar) == True){
            $colores = array($color1 = "verde", $color2 = "verde", $color3 = "verde", $color4 = "verde", $color5 = "verde");
         }   
         elseif(isset($enviar) == NULL){
    ...
    <div class="container">
        ...
        <section class="box-content">
            ...
            <form action="#" method="POST" class="adivinanza">
                ...
                <tfoot>
                    <tr>
                        <td colspan="5"><button name="enviar" value="<?php $enviar ?>">enviar</button></td>
                    </tr>
                </tfoot>
                </form>
            </table>
