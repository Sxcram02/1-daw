        ...
        <section class="box-content">
            ...
            <form action="#" method="POST" class="adivinanza">
                ...
                <tbody>
                        ...
                        <tr>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $colores[0];?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $colores[1];?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $colores[2];?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $colores[3];?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $colores[4];?>"></td>
                        </tr>
                </tbody>
                <tfoot>
                    <tr>
