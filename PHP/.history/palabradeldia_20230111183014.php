     ...
     $intento = 0;
         ...
         if(isset($enviar) == True){
              for($i; $i<4; $i++){
                ...
                elseif(in_array($palabra2[$i], $palabra[$i])){
                    $colores = array("amarrillo", "amarrillo", "amarrillo", "amarrillo", "amarrillo");
                }
                else
            ...
            <form action="#" method="POST" class="adivinanza">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="letra2" class="<?php echo "$color1";?>"></td>
                            <td><input type="text" name="letra3" class="<?php echo "$color1";?>"></td>
                            <td><input type="text" name="letra4" class="<?php echo "$color1";?>"></td>
                            <td><input type="text" name="letra5" class="<?php echo "$color1";?>"></td>
                        </tr>
                </tbody>
                <tfoot>
                    <tr>
