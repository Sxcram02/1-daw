<?php
    ...
    if($enviar == "enviar" AND count($palabra2) == 4){
        for($i = 0; $i < 5; $i++){
        ...
        <section class="box-content">
            ...
            <form action="#" method="POST" class="adivinanza">
                ...
                <tbody>
                        ...
                        <tr>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $color1;?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $color2;?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $color3;?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $color4;?>"></td>
                            <td><input type="text" name="respuesta" value="<?php echo "$respuesta"?>" class="<?php echo $color5;?>"></td>
                        </tr>
                </tbody>
                <tfoot>
                    <tr>
