...
include_once('archivoextern.php');

require_once('archivoextern.php');
...
if('archivoextern.php'){
    exit('<p>ESTO ES UNA SALIDA DEL ARCHIVO</p>');
};
...
<?php
// este es una continiación del anterior
// operador de fusión NULL, estudialo en el libro
// que ocurre en el echo
echo 'Empezamos '.($nombre??$apellido??$nif??$telefono??'ahora si ') . '<br />';
...
// ¿y ahora?
$nombre = 'Rebustiano'; // si repites el echo ¿qué ocurrira?
// realiza una simulacion similar por tu cuenta



$nombre2 = 'juan';
echo ($nombre2??$dni??$telefono),'<br />';
...
$valor ??=$telefono??$apellido??$nombre??$nif;
echo $valor, '<br />';

// explica que ha ocurrido
// SI TELEFONO NO SE HA INICIALIZADO COMPROBARA 
//QUE VALORES SON NULOS E IMPRIMIRA LOS QUE NO LO SON
// realiza una simulacion similar por tu cuenta
$nombre3= "Alberto";
$valores ??=$ABUELLO??$apellido??$nombre3;
echo $valores;
...
// comprueba el operador en todas las posiblilidades de las tres variables 
