<?php
    ...
    $respuesta = array($_POST['respuesta[]']);
        ...
        <section class="box-content">
            ...
            <form action="#" method="POST" class="adivinanza">
                ...
                <tbody>
                        ...
                        <tr>
                            <td><input type="text" name="respuesta[]" value="<?php echo "$respuesta[0]"?>" class="<?php echo $colores[0];?>"></td>
                            <td><input type="text" name="respuesta[]" value="<?php echo "$respuesta[1]"?>" class="<?php echo $colores[1];?>"></td>
                            <td><input type="text" name="respuesta[]" value="<?php echo "$respuesta[2]"?>" class="<?php echo $colores[2];?>"></td>
                            <td><input type="text" name="respuesta[]" value="<?php echo "$respuesta[3]"?>" class="<?php echo $colores[3];?>"></td>
                            <td><input type="text" name="respuesta[]" value="<?php echo "$respuesta[4]"?>" class="<?php echo $colores[4];?>"></td>
                        </tr>
                </tbody>
                <tfoot>
                    <tr>
