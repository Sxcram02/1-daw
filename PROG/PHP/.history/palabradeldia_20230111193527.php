        ...
        if($enviar == "enviar"){
         for($i = 0; $i < 4; $i++){
            if($palabra[$i] == $palabra2[$i]){
                $colores = array($color1 = "verde", $color2 = "verde", $color3 = "verde",
                $color4 = "verde", $color5 = "verde");
            }
            elseif(in_array($palabra[$i], $palabra)){
                $colores = array($color1 = "amarillo", $color2 = "amarillo", $color3 = "amarillo",
                $color4 = "amarillo", $color5 = "amarrillo");
            }
            elseif($palabra2 =! $palabra){
                $colores = array($color1 = "azul", $color2 = "azul", $color3 = "azul",
                $color4 = "azul", $color5 = "azul");
            }
         }
        }   
        else {
